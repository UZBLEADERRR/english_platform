    ...
    <div className="space-y-4">
      ...
      {showForm && (
        <div className="card space-y-3">
          ...
          <textarea value={form.pages} onChange={e => setForm({...form, pages: e.target.value})} placeholder="Sahifa rasmlar URL (har bir qatorda bitta)" className="input min-h-[80px] font-mono text-xs" />
